...
//             { paddingHorizontal: width < 400 ? scale(8) : scale(24) },
//           ]}
//         >
//           {realCards.map((card, index) => {
//             const CardComponent = card.comp;
...
const GiftCardsScreen = () => {
  ...
  const realCards = [
    ...
    { key: "6", comp: GiftCard3 },
    { key: "7", comp: GiftCard4 },
    { key: "8", comp: GiftCard5 },
  ];
  ...
  // ✅ Recipient validation only when not buying for myself
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <ScrollView
          ...
          showsHorizontalScrollIndicator={false}
          contentContainerStyle={styles.thumbnailContainer}
          style={[styles.thumbnailScroll, { paddingHorizontal: scale(8) }]}
        >
          {realCards.map((card, index) => {
            const CardComponent = card.comp;
            const isSelected = activeThumbIndex === index;
        ...
        <View style={styles.formContainer}>
          ...
          {/* ✅ Hide recipient fields when buying for myself */}
          {!isBuyingForMyself && (
            <View style={styles.inputContainer}>
              <FloatingLabelInput
                label="Recipient Name*"

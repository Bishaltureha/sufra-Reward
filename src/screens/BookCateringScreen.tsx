...
type BookCateringScreenNavigationProp = DrawerNavigationProp<
  DrawerParamList,
  "BookCatering"
>;

const BookCateringScreen = () => {
  const navigation = useNavigation<BookCateringScreenNavigationProp>();
      ...
      <View style={{ backgroundColor: "#fff" }}>
        <View style={styles.header}>
          ...
          <View style={styles.titleContainer}>
            <Text style={styles.headerTitle}>Book Catering</Text>
          </View>

...
const ProductDetailsWithImage = () => {
  const route = useRoute<ProductDetailsWithImageRouteProp>();
  ...
  const proteinOptions = [
    {
      id: 0,
      name: "Chicken Per-Peri",
      price: "(+10 SR)",
      image: require("../../assets/image/productImage/ChickenPer-Peri.png"),
    },
    {
      id: 1,
      name: "Braised Beef (Barbacoa)",
      price: "(+6 SR)",
      image: require("../../assets/image/productImage/BraisedBeef(Barbacoa).png"),
    },
    {
      id: 2,
      name: "Sofritas",
      price: "(+6 SR)",
      image: require("../../assets/image/productImage/Sofritas.png"),
    },
    {
      id: 3,
      name: "Veggies",
      price: "(+6 SR)",
      image: require("../../assets/image/productImage/Veggies.png"),
    },
  ];
  const Extra = [
    {
      ...
      name: "White Rice",
      price: "(+6 SR)",
      image: require("../../assets/image/productImage/WhiteRice.png"),
    },
    {
      id: 1,
      name: "Brown Rice",
      price: "(+10 SR)",
      image: require("../../assets/image/productImage/BrownRice.png"),
    },
    {
      id: 2,
      name: "Black Beans",
      price: "(+6 SR)",
      image: require("../../assets/image/productImage/BlackBeans.png"),
    },
    {
      id: 3,
      name: "Pinto Beans",
      price: "(+10 SR)",
      image: require("../../assets/image/productImage/PintoBeans.png"),
    },
    {
      id: 4,
      name: "Fresh Tomato Salsa",
      price: "(+6 SR)",
      image: require("../../assets/image/productImage/FreshTomatoSalsa.png"),
    },
  ];
  const Different = [
    {
      ...
      price: "(+10 SR)",
      image: require("../../assets/image/productImage/SideofGuacamole.png"),
    },
    {
      id: 1,
      name: "Fountain Drinks",
      price: "(+6 SR)",
      image: require("../../assets/image/productImage/FountainDrinks.png"),
    },
    {
      id: 2,
      name: "Chips & Guacamole",
      price: "(+6 SR)",
      image: require("../../assets/image/productImage/ChipsAndGuacamole.png"),
    },
    {
      id: 3,
      name: "Chips",
      price: "(+6 SR)",
      image: require("../../assets/image/productImage/Chips.png"),
    },
  ];
  ...
  const isAddToCartEnabled = () => {
    ...
    const hasExtras = selectedExtras.length === 2; // Exactly 2
    const hasDifferent = selectedDifferent.length === 4; // Exactly 5

    // Don't check proteinSizeConfirmed here!
  ...
  const getSubtitleColor = (
    ...
    if (sectionType === "protein") {
      ...
      return selectedDifferent.length === 4 ? "#017851" : "#EF4444";
    }
    return "#717171";
  };
  const getSubtitleBackGroundColor = (
    sectionType: "protein" | "extras" | "different"
  ) => {
    if (sectionType === "protein") {
      return selectedProtein !== null ? "#c8ded7" : "#fad9df";
    } else if (sectionType === "extras") {
      return selectedExtras.length === 2 ? "#c8ded7" : "#fad9df";
    } else if (sectionType === "different") {
      return selectedDifferent.length === 4 ? "#c8ded7" : "#fad9df";
    }
    return "#717171";
  };
            ...
            <View style={styles.sectionHeader}>
              ...
              <View
                style={[
                  ...
                  { backgroundColor: getSubtitleBackGroundColor("extras") },
                ]}
              >
                <Text
                  style={[
          ...
          >
            <View style={styles.sectionHeader}>
              ...
              <View
                style={[
                  styles.optionalBadge,
                  { backgroundColor: getSubtitleBackGroundColor("different") },
                ]}
              >
                <Text
                  style={[
...
export default ProductDetailsWithImage;

...
export const translations = {
  en: {
    ...
    drawer: {
      ...
      getHelp: "Get Help",
      faq: "FAQ",
      loginOrRegister: "Click to Login or \nRegister",
      accountDetails: "Click to see account details",
      new: "NEW!",
    },
  },
  ar: {
    ...
    drawer: {
      ...
      dineIn: "تناول الطعام",
      deals: "العروض",
      bookCatering: "حجز خدمة الطعام",
      orderTracking: "تتبع الطلب",
      myFavorites: "المفضلة",
      myOrders: "طلباتي",
      myAddresses: "عناويني",
      myPaymentMethods: "طرق الدفع",
      getHelp: "المساعدة",
      faq: "الأسئلة الشائعة",
      loginOrRegister: "اضغط لتسجيل الدخول أو \nإنشاء حساب",
      accountDetails: "اضغط لرؤية تفاصيل الحساب",
      new: "جديد!",
    },
  },
} as const;
